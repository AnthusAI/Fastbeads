// Package main implements the fbd CLI state management commands.
...
Examples:
  ...
  fbd state witness-abc mode       # Output: normal
  fbd state witness-abc health     # Output: healthy`,
...
Examples:
  ...
  fbd set-state witness-abc mode=degraded --reason "High error rate detected"
  fbd set-state witness-abc health=healthy
