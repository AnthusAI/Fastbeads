...
// obsidianCheckbox maps fbd status to Obsidian Tasks checkbox syntax
...
// obsidianPriority maps fbd priority (0-4) to Obsidian priority emoji
...
// obsidianTypeTag maps fbd issue type to Obsidian tag (core types only)
