...
var quickstartCmd = &cobra.Command{
	Use:     "quickstart",
	GroupID: "setup",
	Short:   "Quick start guide for fbd",
	Long:    `Display a quick start guide showing common fbd workflows and patterns.`,
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Printf("\n%s\n\n", ui.RenderBold("fbd - Dependency-Aware Issue Tracker"))
		fmt.Printf("Issues chained together like beads.\n\n")

		fmt.Printf("%s\n", ui.RenderBold("GETTING STARTED"))
		fmt.Printf("  %s   Initialize fbd in your project\n", ui.RenderAccent("fbd init"))
		...
		fmt.Printf("  %s\n", ui.RenderAccent("fbd update bd-1 --status in_progress"))
		fmt.Printf("  %s\n", ui.RenderAccent("fbd update bd-1 --priority 0"))
		fmt.Printf("  %s\n\n", ui.RenderAccent("fbd update bd-1 --assignee bob"))

		fmt.Printf("%s\n", ui.RenderBold("CLOSING ISSUES"))
		fmt.Printf("  %s\n", ui.RenderAccent("fbd close bd-1"))
		fmt.Printf("  %s\n\n", ui.RenderAccent("fbd close bd-2 bd-3 --reason \"Fixed in PR #42\""))

		fmt.Printf("%s\n", ui.RenderBold("DATABASE LOCATION"))
		fmt.Printf("  fbd automatically discovers your database:\n")
		...
		fmt.Printf("  fbd is designed for AI-supervised workflows:\n")
		...
		fmt.Printf("  Applications can extend fbd's SQLite database:\n")
		...
		fmt.Printf("      %s\n\n", ui.RenderAccent("https://github.com/steveyegge/fastbeads/blob/main/docs/EXTENDING.md"))

		fmt.Printf("%s\n", ui.RenderBold("GIT WORKFLOW (AUTO-SYNC)"))
		fmt.Printf("  fbd automatically keeps git in sync:\n")
