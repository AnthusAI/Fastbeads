...
Examples:
  ...
  fbd comments bd-123 --json

  # Add a comment
  fbd comments add bd-123 "This is a comment"

  # Add a comment from a file
  fbd comments add bd-123 -f notes.txt`,
...
Examples:
  # Add a comment
  fbd comments add bd-123 "Working on this now"
...
var commentCmd = &cobra.Command{
	...
	Long:       `Add a comment to an issue. This is an alias for 'fbd comments add'.`,
	Args:       cobra.MinimumNArgs(1),
	Run:        commentsAddCmd.Run,
	Hidden:     true,
	Deprecated: "use 'fbd comments add' instead (will be removed in v1.0.0)",
}
