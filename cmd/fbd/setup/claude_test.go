...
func TestRemoveHookCommandNoNull(t *testing.T) {
	...
	removeHookCommand(hooks, "SessionStart", "fbd prime")
...
func TestHasBeadsHooks(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "has fbd prime --stealth hook",
			settingsData: map[string]interface{}{
				"hooks": map[string]interface{}{
					"SessionStart": []interface{}{
						map[string]interface{}{
		...
		{
			name: "has fbd prime in PreCompact",
			settingsData: map[string]interface{}{
				"hooks": map[string]interface{}{
		...
		{
			name: "has fbd prime --stealth in PreCompact",
			settingsData: map[string]interface{}{
				"hooks": map[string]interface{}{
					"PreCompact": []interface{}{
						map[string]interface{}{
		...
		{
			name: "has other hooks but not fbd prime",
			settingsData: map[string]interface{}{
				"hooks": map[string]interface{}{
					"SessionStart": []interface{}{
						map[string]interface{}{
...
func TestIdempotency(t *testing.T) {
	...
	// First add
	added1 := addHookCommand(hooks, "SessionStart", "fbd prime")
	if !added1 {
		t.Error("First call should have added the hook")
	}

	// Second add (should detect existing)
	added2 := addHookCommand(hooks, "SessionStart", "fbd prime")
	if added2 {
...
func TestIdempotencyWithStealth(t *testing.T) {
	...
	if !addHookCommand(hooks, "SessionStart", "fbd prime --stealth") {
	...
	if cmdMap["command"] != "fbd prime --stealth" {
		t.Errorf("Expected 'fbd prime --stealth', got %v", cmdMap["command"])
	}
}
...
func TestInstallClaudeGlobalStealth(t *testing.T) {
	...
	if !strings.Contains(string(data), "fbd prime --stealth") {
...
func TestCheckClaudeScenarios(t *testing.T) {
			...
			"hooks": map[string]interface{}{
				"SessionStart": []interface{}{
					map[string]interface{}{
						"matcher": "",
						"hooks": []interface{}{
							map[string]interface{}{"type": "command", "command": "fbd prime"},
						},
					},
				},
			},
	...
	t.Run("missing hooks", func(t *testing.T) {
		...
		if !strings.Contains(stdout.String(), "Run: fbd setup claude") {
...
func TestRemoveClaudeScenarios(t *testing.T) {
	t.Run("remove global hooks", func(t *testing.T) {
		...
		if strings.Contains(string(data), "fbd prime") {
			t.Error("expected fbd prime hooks removed")
		}
