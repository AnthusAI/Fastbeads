...
// This is a convenience alias for 'fbd list --parent <id>'.
...
Examples:
  fbd children hq-abc123        # List children of hq-abc123
  fbd children hq-abc123 --json # List children in JSON format
  fbd children hq-abc123 --pretty # Show children in tree format`,
