...
func TestMergeSyncBranch_OnSyncBranch(t *testing.T) {
	...
	// Initialize fbd database and set sync.branch
...
func TestConcurrentEdit(t *testing.T) {
	...
	// Set issue_prefix
	if err := testStore.SetConfig(ctx, "issue_prefix", "fbd"); err != nil {
...
// This validates the P0 fix for preventing data corruption when running fbd sync
