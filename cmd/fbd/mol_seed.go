...
Examples:
  fbd mol seed --patrol                    # Verify all patrol formulas
  fbd mol seed mol-feature                 # Verify specific formula
  fbd mol seed mol-review --var name=test  # Verify with variable substitution`,
