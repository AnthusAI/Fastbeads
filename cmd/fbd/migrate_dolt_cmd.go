...
Examples:
  fbd migrate dolt            # Interactive migration with confirmation
  fbd migrate dolt --dry-run  # Preview what would happen
  fbd migrate dolt --yes      # Non-interactive (for automation)`,
