...
// writeJSONLAtomic writes JSONL to a temp file and atomically renames into place.
// This is used for --no-db mode persistence and other JSONL-only paths.
func writeJSONLAtomic(path string, issues []*types.Issue) ([]string, error) {
