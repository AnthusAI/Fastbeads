...
var templateCmd = &cobra.Command{
	...
	Deprecated: "use 'fbd mol' instead (will be removed in v1.0.0)",
...
To create a template:
  ...
  2. Add the 'template' label: fbd label add <epic-id> template
  3. Use {{variable}} placeholders in titles/descriptions

To use a template:
  fbd template instantiate <id> --var key=value`,
}

var templateListCmd = &cobra.Command{
	Use:        "list",
	Short:      "List available templates",
	Deprecated: "use 'fbd formula list' instead (will be removed in v1.0.0)",
	Run: func(cmd *cobra.Command, args []string) {
		...
		if len(beadsTemplates) == 0 {
			...
			fmt.Println("  2. Add the 'template' label: fbd label add <epic-id> template")
			fmt.Println("  3. Use {{variable}} placeholders in titles/descriptions")
			return
		}

		fmt.Printf("%s\n", ui.RenderPass("Templates (for fbd template instantiate):"))
...
var templateShowCmd = &cobra.Command{
	...
	Deprecated: "use 'fbd mol show' instead (will be removed in v1.0.0)",
...
var templateInstantiateCmd = &cobra.Command{
	...
	Deprecated: "use 'fbd mol bond' instead (will be removed in v1.0.0)",
...
Example:
  fbd template instantiate bd-abc123 --var version=1.2.0 --var date=2024-01-15`,
	Args: cobra.ExactArgs(1),
	Run: func(cmd *cobra.Command, args []string) {
