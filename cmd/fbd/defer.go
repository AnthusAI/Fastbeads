...
Deferred issues don't show in 'fbd ready' but remain visible in 'fbd list'.

Examples:
  fbd defer bd-abc                  # Defer a single issue (status-based)
  fbd defer bd-abc --until=tomorrow # Defer until specific time
  fbd defer bd-abc bd-def           # Defer multiple issues`,
