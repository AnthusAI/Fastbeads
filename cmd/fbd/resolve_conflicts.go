...
Examples:
  fbd resolve-conflicts                    # Resolve conflicts in .beads/beads.jsonl
  fbd resolve-conflicts --dry-run          # Show what would be resolved
  fbd resolve-conflicts custom.jsonl       # Resolve conflicts in custom file
  fbd resolve-conflicts --json             # Output results as JSON`,
