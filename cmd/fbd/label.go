// Package main implements the fbd CLI label management commands.
package main
...
var labelAddCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		// provides:* labels can only be added via 'fbd ship' command
		if strings.HasPrefix(label, "provides:") {
			FatalErrorRespectJSON("'provides:' labels are reserved for cross-project capabilities. Hint: use 'fbd ship %s' instead", strings.TrimPrefix(label, "provides:"))
		}
