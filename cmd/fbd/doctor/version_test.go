...
func TestUpgradeCommandForPath(t *testing.T) {
	tests := []struct {
		...
		{"homebrew apple silicon", "/opt/homebrew/Cellar/beads/0.49.4/bin/fbd", "brew upgrade beads"},
		{"homebrew intel mac", "/usr/local/Cellar/beads/0.49.4/bin/fbd", "brew upgrade beads"},
		{"homebrew linux", "/home/linuxbrew/.linuxbrew/Cellar/beads/0.49.4/bin/fbd", "brew upgrade beads"},
		{"legacy tap formula", "/opt/homebrew/Cellar/fbd/0.49.0/bin/fbd", "brew upgrade beads"},
		{"usr local bin symlink", "/usr/local/bin/fbd", installScriptCommand},
		{"go install", "/home/user/go/bin/fbd", installScriptCommand},
	}
