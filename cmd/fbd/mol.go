...
//
// Usage:
//   fbd mol show <id>                      # Show proto/molecule structure
//   fbd mol pour <id> --var key=value      # Instantiate proto → persistent mol
//   fbd mol wisp <id> --var key=value      # Instantiate proto → ephemeral wisp
...
Use "fbd formula list" to list available formulas.`,
}
