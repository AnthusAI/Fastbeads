...
TODOs are regular task-type issues with convenient shortcuts:
  fbd todo add "Title"    -> fbd create "Title" -t task -p 2
  fbd todo                -> fbd list --type task --status open
  fbd todo done <id>      -> fbd close <id>

TODOs can be promoted to full issues by changing type or priority:
  fbd update todo-123 --type bug --priority 0`,
