...
var cleanupAliasCmd = &cobra.Command{
	Use:        "cleanup",
	Hidden:     true,
	Deprecated: "use 'fbd admin cleanup' instead (will be removed in v1.0.0)",
	Short:      "Alias for 'fbd admin cleanup' (deprecated)",
...
var compactAliasCmd = &cobra.Command{
	Use:        "compact",
	Hidden:     true,
	Deprecated: "use 'fbd admin compact' instead (will be removed in v1.0.0)",
	Short:      "Alias for 'fbd admin compact' (deprecated)",
...
var resetAliasCmd = &cobra.Command{
	Use:        "reset",
	Hidden:     true,
	Deprecated: "use 'fbd admin reset' instead (will be removed in v1.0.0)",
	Short:      "Alias for 'fbd admin reset' (deprecated)",
	Long:       resetCmd.Long,
	Run: func(cmd *cobra.Command, args []string) {
