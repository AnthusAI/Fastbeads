...
Examples:
  fbd relate bd-abc bd-xyz    # Link two related issues
  fbd relate bd-123 bd-456    # Create see-also connection`,
...
func init() {
	...
	relateAliasCmd.Deprecated = "use 'fbd dep relate' instead (will be removed in v1.0.0)"
	rootCmd.AddCommand(&relateAliasCmd)

	unrelateAliasCmd := *unrelateCmd
	unrelateAliasCmd.Hidden = true
	unrelateAliasCmd.Deprecated = "use 'fbd dep unrelate' instead (will be removed in v1.0.0)"
