...
var mergeCmd = &cobra.Command{
	...
	Long: `fbd merge is a git merge driver for beads issue tracker JSONL files.

NOTE: This command is for git merge operations, NOT for merging duplicate issues.
To merge duplicate issues, use 'fbd duplicates --auto-merge' instead.
...
Or use 'fbd init' which automatically configures the merge driver.
...
Vendored into fbd with permission.`,
