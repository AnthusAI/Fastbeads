...
Examples:
  fbd gate discover           # Auto-discover run IDs for all matching gates
  fbd gate discover --dry-run # Preview what would be matched (no updates)
  fbd gate discover --branch main --limit 10  # Only match runs on 'main' branch`,
	Run: runGateDiscover,
}
