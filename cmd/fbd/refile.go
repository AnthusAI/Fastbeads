...
Examples:
  fbd refile bd-8hea gastown     # Move to gastown by rig name
  fbd refile bd-8hea gt-         # Move to gastown by prefix
  fbd refile bd-8hea gt          # Move to gastown (prefix without hyphen)`,
