...
var thanksCmd = &cobra.Command{
	...
	Hidden: true, // Deprecated: use 'fbd info --thanks' instead
	Long: `Display a thank you page listing all human contributors to the beads project.

DEPRECATED: Use 'fbd info --thanks' instead.

Examples:
  fbd info --thanks       # Show thank you page (preferred)
  fbd thanks              # Legacy command (still works)
`,
