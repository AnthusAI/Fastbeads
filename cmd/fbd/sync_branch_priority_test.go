...
// fbd sync should NOT fall back to --from-main mode even if the current branch has no upstream.
...
// fbd sync bypasses gitHasBeadsChanges and always calls CommitToSyncBranch.
