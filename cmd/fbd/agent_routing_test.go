...
// TestAgentStateWithRouting tests that fbd agent state respects routes.jsonl
// for cross-repo agent resolution. This is a regression test for the bug where
// fbd agent state failed to find agents in routed databases while fbd show worked.
//
...
// TestAgentHeartbeatWithRouting tests that fbd agent heartbeat respects routes.jsonl
//
// NOTE: This test uses os.Chdir and cannot run in parallel with other tests.
...
// TestAgentShowWithRouting tests that fbd agent show respects routes.jsonl
//
// NOTE: This test uses os.Chdir and cannot run in parallel with other tests.
...
// fbd show should query that store directly instead of prefix-routing to a rig.
//
// NOTE: This test uses os.Chdir and cannot run in parallel with other tests.
