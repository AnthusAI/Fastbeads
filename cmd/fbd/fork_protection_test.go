...
func TestIsUpstreamRepo(t *testing.T) {
	tests := []struct {
		...
		{"https upstream", "https://github.com/steveyegge/fastbeads.git", true},
		{"https upstream no .git", "https://github.com/steveyegge/fastbeads", true},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			upstreamPatterns := []string{
				...
				"https://github.com/steveyegge/fastbeads",
			}
...
func TestIsUpstreamRepo_Maintainer(t *testing.T) {
	...
	addRemote(t, dir, "origin", "https://github.com/steveyegge/fastbeads.git")
...
func TestIsForkOfBeads_StandardFork(t *testing.T) {
	dir := setupGitRepoForForkTest(t)
	addRemote(t, dir, "origin", "https://github.com/peterkc/beads.git")
	addRemote(t, dir, "upstream", "https://github.com/steveyegge/fastbeads.git")
...
func TestIsForkOfBeads_CustomNaming(t *testing.T) {
	dir := setupGitRepoForForkTest(t)
	addRemote(t, dir, "origin", "https://github.com/peterkc/beads.git")
	addRemote(t, dir, "github", "https://github.com/steveyegge/fastbeads.git")
