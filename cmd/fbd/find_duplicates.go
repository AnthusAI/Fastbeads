...
Unlike 'fbd duplicates' which finds exact content matches, find-duplicates
...
Examples:
  fbd find-duplicates                       # Mechanical similarity (default)
  fbd find-duplicates --threshold 0.4       # Lower threshold = more results
  fbd find-duplicates --method ai           # Use AI for semantic comparison
  fbd find-duplicates --status open         # Only check open issues
  fbd find-duplicates --limit 20            # Show top 20 pairs
  fbd find-duplicates --json                # JSON output`,
