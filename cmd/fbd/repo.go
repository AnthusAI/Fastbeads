...
Examples:
  fbd repo add ~/beads-planning       # Add planning repo
  fbd repo add ../other-repo          # Add relative path repo
  fbd repo list                       # Show all configured repos
  fbd repo remove ~/beads-planning    # Remove by path
  fbd repo sync                       # Sync from all configured repos`,
}
...
shared across all clones of this repository.`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		fmt.Printf("Run 'fbd repo sync' to hydrate issues from this repository.\n")
		return nil
	},
}
