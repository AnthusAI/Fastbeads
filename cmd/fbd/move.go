...
The target rig can be specified as:
  ...
  - A prefix: bd-, gt-
  - A prefix without hyphen: fbd, gt
...
Examples:
  fbd move hq-c21fj --to beads     # Move to beads by rig name
  fbd move hq-q3tki --to gt-       # Move to gastown by prefix
  fbd move hq-1h2to --to gt        # Move to gastown (prefix without hyphen)`,
