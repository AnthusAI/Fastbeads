...
Examples:
  fbd diff main feature-branch   # Compare main to feature branch
  fbd diff HEAD~5 HEAD           # Show changes in last 5 commits
  fbd diff abc123 def456         # Compare two specific commits`,
