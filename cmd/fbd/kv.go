...
Examples:
  fbd kv set mykey myvalue    # Set a value
  fbd kv get mykey            # Get a value
  fbd kv clear mykey          # Delete a key
  fbd kv list                 # List all key-value pairs`,
}
...
Examples:
  fbd kv get feature_flag
  fbd kv get api_endpoint`,
