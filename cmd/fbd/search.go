...
Examples:
  ...
  fbd search "database" --label backend --limit 10
  fbd search --query "performance" --assignee alice
  fbd search "bd-5q" # Search by partial ID
  fbd search "security" --priority-min 0 --priority-max 2
  fbd search "bug" --created-after 2025-01-01
  fbd search "refactor" --updated-after 2025-01-01 --priority-min 1
  fbd search "bug" --sort priority
  fbd search "task" --sort created --reverse
  fbd search "api" --desc-contains "endpoint"
  fbd search "cleanup" --no-assignee --no-labels`,
