...
var (
	// Version is the current version of fbd (overridden by ldflags at build time)
	Version = "0.49.6"
...
func showDaemonVersion() {
	...
	if err != nil || client == nil {
		...
		fmt.Fprintf(os.Stderr, "Hint: start daemon with 'fbd daemon'\n")
		os.Exit(1)
	}
