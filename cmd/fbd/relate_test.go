...
// TestRelateCommand tests the fbd relate command functionality.
...
func TestRelateCommand(t *testing.T) {
	...
	t.Run("relate creates bidirectional link", func(t *testing.T) {
		...
		// Simulate what fbd relate does: add bidirectional relates-to
	...
	t.Run("unrelate removes bidirectional link", func(t *testing.T) {
		...
		// Simulate what fbd unrelate does: remove both directions
