...
Examples:
  fbd lint                    # Lint all open issues
  fbd lint bd-abc             # Lint specific issue
  fbd lint bd-abc bd-def      # Lint multiple issues
  fbd lint --type bug         # Lint only bugs
  fbd lint --status all       # Lint all issues (including closed)
`,
