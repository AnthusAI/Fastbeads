...
// GatedReadyOutput is the JSON output for fbd mol ready --gated
...
Examples:
  fbd mol ready --gated           # Find all gate-ready molecules
  fbd mol ready --gated --json    # JSON output for automation`,
