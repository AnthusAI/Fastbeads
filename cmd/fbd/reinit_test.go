...
func testFreshCloneAutoImport(t *testing.T) {
	...
	// Run fbd init with auto-import disabled to test checkGitForIssues
...
func testDatabaseRemovalScenario(t *testing.T) {
	...
	// Simulate rm -rf .beads/ followed by partial fbd init
	// (in practice, fbd init creates config.yaml before auto-import)
